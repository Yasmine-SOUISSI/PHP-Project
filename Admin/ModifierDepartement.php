                    ...
                    <table border="1" align="center">
                        <tr>
                            ...
                            <td><input type="text" name="ID_DEPART" id="ID_DEPART"
                                    value="<?php echo $departement['ID_DEPART']; ?>" maxlength="5"></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="text" name="NOM_DEPART" id="NOM_DEPART"
                                    value="<?php echo $departement['NOM_DEPART']; ?>" maxlength="20"></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="text" name="NB_PLACES" id="NB_PLACES"
                                    value="<?php echo $departement['NB_PLACES']; ?>" maxlength="3"></td>
                        </tr>
