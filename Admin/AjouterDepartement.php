...
include_once '../Models/Departement.php';
...
$departement=NULL;
if (isset($_POST['d'])&&isset($_POST['e'])&&isset($_POST['f'])&&isset($_POST['g'])&&isset($_POST['h']))
{
    if (!empty($_POST['d'])&&!empty($_POST['e'])&&!empty($_POST['f'])&&!empty($_POST['g'])&&!empty($_POST['h']))
    {
        $departement= new Departement($_POST['d'],$_POST['e'],$_POST['f'],$_POST['g'],$_POST['h']);
        $depC=new DepartementC();
        $depC->AjouterDepartement($departement);
            ...
            <div id="body">
                ...
                <body>
                    <form action="" method="post">
                        <div>
                            <label for="ID_DEPART">ID_DEPART:</label>
                            <input type="text" name='d'>
                        </div>
                        <div>
                            <label for="NOM_DEPART">Nom_DEPART:</label>
                            <input type="text" name='e'>
                        </div>
                        <div>
                            <label for="NB_PLACES">NB_PLACES:</label>
                        ...
                        <div>
                            ...
                            <input type="file" name="h" class="form-control">
                        </div>
                        <div>
                            <input type="submit">
                            <input type="Reset">
