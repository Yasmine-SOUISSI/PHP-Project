...
<head>
    ...
    .banner {
        position: relative;
        height: 200px;
        background-image: url("../amusementparkwebsitetemplate/events.jpg");
            ...
            <form action="" method="POST">
                <table border="1" align="center">
                    <tr>
                        ...
                        <td><input type="text" name="Id_event" id="Id_event" value="<?php echo $event['Id_event']; ?>"
                                maxlength="20"></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td><input type="text" name="nom_event" id="nom_event"
                                value="<?php echo $event['nom_event']; ?>" maxlength="20"></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td><input type="text" name="categorie_E" id="categorie_E"
                                value="<?php echo $event['categorie_E']; ?>" maxlength="20"></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td><input type="text" name="ID_DEPART" id="ID_DEPART"
                                value="<?php echo $event['ID_DEPART']; ?>" maxlength="20"></td>
                    </tr>
                    <tr>
                        <td>
                            <label for="date">date:
                        ...
                        <td><input type="date" name="date" id="date" value="<?php echo $event['date']; ?>"
                                maxlength="20"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="Id_staff" id="Id_staff" value="<?php echo $event['Id_staff']; ?>"
                                maxlength="20"></td>
                    </tr>
