        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <span>Check out upcoming events and grab
                        your ticket right now.</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class=" ticket-item">
                        ...
                        <div class="down-content">
                            ...
                            <ul>
                                <li><i class="fa fa-clock-o"></i><?php echo $row ['date']?>: 05:00 PM to 10:00 PM
                                </li>
                                <li><i class="fa fa-map-marker"></i>Landna</li>
                            </ul>
                            <div class="main-dark-button">
                                <a href="formulaireAchatCopy.php">Purchase Tickets</a>
                            </div>
                        </div>
